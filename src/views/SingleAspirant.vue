...
export default {
  setup(){
     ...
     const user = computed(()=>counter.getAspirant)
    ...
    const items = ref([
      ...
      onMounted(()=>{
        counter.loadSingleAspirant(route.params.id)
       })
    ...
    const Submit = (e : any) => {
              ...
              counter.updateAspirantsCred(route.params.id, payload).then(()=> {
                counter.loadSingleAspirant(route.params.id)
                     notify({
                      title: "Aspirants updated success",
                      text: "Your update was successful, kindly visit your unit to get your voters token",
                      type: "success"
                    });
                  }).catch(error => {
                    notify({
